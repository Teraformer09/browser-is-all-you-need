"""D&D Character GRPO curriculum and Strange-kernel reward adapter.

This experiment module builds eight answer-free D&D Character episodes and
maps twelve authenticated hidden-test kernel results to a dense bipolar reward.
It deliberately stays outside shared trainer and infrastructure code.
"""
