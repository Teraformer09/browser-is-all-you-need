...
| Hugging Face archive | [Terrano09/phone-number-kernel12-GRPO20](https://huggingface.co/Terrano09/phone-number-kernel12-GRPO20) |
...
| Dataset | [Phone_Number_train.jsonl](https://huggingface.co/Terrano09/phone-number-kernel12-GRPO20/blob/main/Phone_Number_train.jsonl) |
...
| 2 | Hugging Face run archive | Public; contains adapters from iterations 4, 9, 14, and 19. |
| 3 | Direct scored adapter | [iter_0000014 adapter](https://huggingface.co/Terrano09/phone-number-kernel12-GRPO20/tree/main/checkpoints/iter_0000014/adapter). |
| 4 | Fixed26 evaluation archive | Four authoritative receipts verified in durable GCS; receipts are not included in the public Hugging Face archive. |
...
| 7 | Result | Pass@1 `11.25/26 (43.27%)`; MEF/pass@2 `15.25/26 (58.65%)`; four trials and 104 samples. |
| 8 | Statistics | Pass@1 CI `7.5-15.0`; pass@2 CI `11.0-19.25`; recovery `16/59 (27.1%)`, CI `13.1-44.2%`. |
| 9 | Repository statistics | Recorded in [statistics.md](../statistics.md) and [per_task_success.csv](../per_task_success.csv). |
| 10 | Reproduction evidence | Launch configurations are committed; raw evaluation receipts remain in durable GCS. |
| 11 | Sky launch command | Recorded below. |
| 12 | PR #3 | Not changed by this release commit. |
...
Dataset artifact: [Terrano09/phone-number-kernel12-GRPO20/Phone_Number_train.jsonl](https://huggingface.co/Terrano09/phone-number-kernel12-GRPO20/blob/main/Phone_Number_train.jsonl)
...
| Trial run ID | Pass@1 | MEF/pass@2 | Phone Number |
| --- | ---: | ---: | --- |
