...
public class MainActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    rideProgressText.setVisibility(View.GONE);
    ...
    applyPillStyle(rideTypeRideButton, true);
    ...
    finalStatusText.setText("Ready to book");
    ...
    rideTypeRideButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        rideType = "Ride";
        if (!rideSequenceError && rideStage == 0) {
          rideStage = 1;
        } else {
          rideSequenceError = true;
        }
        finalStatusText.setText("Ride type selected: Ride");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "ride_type");
        updateRideSummary();
      }
    });

    rideTypeReserveButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        rideType = "Reserve";
        if (!rideSequenceError && rideStage == 0) {
        ...
        finalStatusText.setText("Ride type selected: Reserve");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "ride_type");
        updateRideSummary();
      }
    });

    rideTypePremiumButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        rideType = "Premium";
        if (!rideSequenceError && rideStage == 0) {
        ...
        finalStatusText.setText("Ride type selected: Premium");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "ride_type");
        updateRideSummary();
      }
    });
    ...
    miniButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        selectedRide = "Mini";
        if (!rideSequenceError && rideStage == 2) {
          rideStage = 3;
        } else {
          rideSequenceError = true;
        }
        finalStatusText.setText("Cab type selected: Mini");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "cab_type");
        updateRideSummary();
      }
    });
    ...
    sedanButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        finalStatusText.setText("Cab type selected: Sedan");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "cab_type");
        updateRideSummary();
      }
    });
    ...
    premiumButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        finalStatusText.setText("Cab type selected: Premium");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "cab_type");
        updateRideSummary();
      }
    });
    ...
    cashButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        payment = "cash";
        if (!rideSequenceError && rideStage == 3) {
          rideStage = 4;
        } else {
          rideSequenceError = true;
        }
        finalStatusText.setText("Payment selected: cash");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "payment");
        updateRideSummary();
      }
    });
    ...
    cardButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        finalStatusText.setText("Payment selected: card");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "payment");
        updateRideSummary();
      }
    });
    ...
    upiButton.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        finalStatusText.setText("Payment selected: upi");
        saveRideState(false, false, rideSequenceError ? "ride_validation_error" : "payment");
        updateRideSummary();
      }
    });
    ...
    confirmRideButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        if (!rideSequenceError && rideStage == 4) {
          rideStage = 5;
          finalStatusText.setText("Ride booked: driver assigned");
          saveRideState(true, false, "ride_booked");
        } else {
          rideSequenceError = true;
          finalStatusText.setText("Ride status: missing or out-of-order steps");
  ...
  private void updateRideSummary() {
    if (rideProgressText != null) {
      rideProgressText.setText(String.format(Locale.US, "Step %d/5%s", rideStage, rideSequenceError ? " • blocked" : ""));
    }
  ...
  private void destinationChosenFromInput() {
    String destination = clean(dropInput.getText().toString());
    if (destination.length() == 0) {
      rideSequenceError = true;
      finalStatusText.setText("Ride status: enter a destination");
      saveRideState(false, false, "ride_validation_error");
      updateRideSummary();
      return;
    }
    if (!rideSequenceError && rideStage == 1) {
      rideStage = 2;
      if (routeSummaryText != null) { routeSummaryText.setVisibility(View.VISIBLE); }
      if (cabHeader != null) { cabHeader.setVisibility(View.VISIBLE); }
      if (cabRow != null) { cabRow.setVisibility(View.VISIBLE); }
      if (paymentHeader != null) { paymentHeader.setVisibility(View.VISIBLE); }
      if (paymentRow != null) { paymentRow.setVisibility(View.VISIBLE); }
      if (actionRow != null) { actionRow.setVisibility(View.VISIBLE); }
      finalStatusText.setText("Destination selected: " + destination);
      saveRideState(false, false, "destination");
    } else {
      rideSequenceError = true;
      finalStatusText.setText("Ride status: destination selected out of order");
      saveRideState(false, false, "ride_validation_error");
    }
    updateRideSummary();
  }
