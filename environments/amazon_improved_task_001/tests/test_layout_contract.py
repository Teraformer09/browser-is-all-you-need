...
from amazon_improved_task_001.verification.registry import load_registry
...
class LayoutTests(unittest.TestCase):
    ...
    def test_loading_is_not_authorization(self):
        ...
        self.assertEqual(env.task["task_id"], "amazon_improved_task_001")

    def test_cli_guard_precedes_model_or_device(self):
        cli = importlib.import_module("amazon_improved_task_001.cli")
