...
from amazon_improved_task_001.agents.openrouter import model_info, call_model
...
def export_episode(env, messages, calls, model, started, info):
    ...
    metadata = {"env_id":"terrano09/amazon-improved-task-001","task_id":env.task["task_id"],
