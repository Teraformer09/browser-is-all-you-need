from amazon_improved_task_001.harness.evidence import stamp, save, digest, nodes, prefs_snapshot
import csv
import hashlib
import io
import json
...
class Device:
    ...
    def capture(self, root, index, episode):
        ...
        try:
            ...
            persisted = self.command("shell", "run-as", PACKAGE, "cat", "shared_prefs/shopping_state.xml")
