from amazon_improved_task_001.specs import task_path, fingerprints
from amazon_improved_task_001 import VERSION
import argparse
import base64
import json
import os
...
from amazon_improved_task_001.harness.actions import decode, schema_error, permission_error
from amazon_improved_task_001.harness.device import Device
from amazon_improved_task_001.harness.evidence import save, digest
from amazon_improved_task_001.verification.registry import load_registry, evaluate
from amazon_improved_task_001.verification.progress import progress
from amazon_improved_task_001.verification.generic.interaction import target_ok
from amazon_improved_task_001.verification.task_checks import endpoint_test, cart_complete
...
class Episode:
    ...
    def step(self, raw):
        ...
        if after["errors"]:
            ...
            from amazon_improved_task_001.harness.acceptance import assess_acceptance
