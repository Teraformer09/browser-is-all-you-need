from amazon_improved_task_001.verification.contracts import require
from amazon_improved_task_001.verification.evidence_readers import state, artifact
from amazon_improved_task_001.verification.records import verify as record_verify
from amazon_improved_task_001.verification.scoring import POLICY_IDS
...
def validity_check(c, policy):
    ...
    if policy == "V1":
        ...
        require(len(VERIFIERS) == 5 * len(POLICY_IDS), "VERIFIER_REGISTRY_INCOMPLETE")
        return True
    if policy == "V2":
