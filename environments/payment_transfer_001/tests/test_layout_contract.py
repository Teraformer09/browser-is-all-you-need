...
from payment_transfer_001.verification.registry import load_registry
from payment_transfer_001 import load_environment
from payment_transfer_001.integrations.prime_env import episode_reward
...
class LayoutTests(unittest.TestCase):
    ...
    def test_loading_is_not_authorization(self):
        ...
        self.assertEqual(env.task["task_id"], "payment_transfer_001")

    def test_cli_guard_precedes_model_or_device(self):
        cli = importlib.import_module("payment_transfer_001.cli")
